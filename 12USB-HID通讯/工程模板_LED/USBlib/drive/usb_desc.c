...
const u8 CustomHID_DeviceDescriptor[CUSTOMHID_SIZ_DEVICE_DESC] =
{
    ...
    0x40,                       /*bMaxPacketSize40*/	//最大数据包长度 / byte
    0x83,                       /*idVendor (0x0483)*/  //申请VID
    0x04,
    0x15,                       /*idProduct = 0x5750*/ //自定义PID
    0x04,
...
/*   All Descriptors (Configuration, Interface, Endpoint, Class, Vendor 配置描述符*/
