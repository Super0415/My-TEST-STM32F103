...
#define	usDBpGovTuneGain           (*((INT16U*)aDBParam+ 46))
#define	usDBpGovTuneStability      (*((INT16U*)aDBParam+ 47))
#define	usDBpGovTuneDerivative     (*((INT16U*)aDBParam+ 48))
#define	ssDBpGovTuneCtrlInit       (*((INT16S*)aDBParam+ 49))
...
#define ssDBmGovTuningCtrl         (*((INT16S*)aDBMeasu+ 48))
...
#define usDBmEngineIsStopped       (*((INT16U*)aDBMeasu+ 55))
#define usDBmEngineIsRunning       (*((INT16U*)aDBMeasu+ 56))
#define usDBmEngineIsIdling        (*((INT16U*)aDBMeasu+ 57))
#define usDBmEngineIsRated         (*((INT16U*)aDBMeasu+ 58))
#define usDBmEmergnErrorToStop     (*((INT16U*)aDBMeasu+ 59))
#define usDBmCommonErrorToStop     (*((INT16U*)aDBMeasu+ 60))
#define usDBmCommonErrorToWarn     (*((INT16U*)aDBMeasu+ 61))
#define usDBmEngineStartActive     (*((INT16U*)aDBMeasu+ 62))
#define usDBmEngineStopActive      (*((INT16U*)aDBMeasu+ 63))
#define usDBmAutoModeActive        (*((INT16U*)aDBMeasu+ 64))
#define usDBmAirHeatDuration       (*((INT16U*)aDBMeasu+ 65))
#define usDBmAirHeatActive         (*((INT16U*)aDBMeasu+ 66))
#define usDBmOilPumpActive         (*((INT16U*)aDBMeasu+ 67))
#define usDBmFuelSupplyActive      (*((INT16U*)aDBMeasu+ 68))
#define usDBmStartFailTimes        (*((INT16U*)aDBMeasu+ 69))
#define usDBmStarterActive         (*((INT16U*)aDBMeasu+ 70))
#define usDBmCoolantFanActive      (*((INT16U*)aDBMeasu+ 71))
#define usDBmSpeedRatedActive      (*((INT16U*)aDBMeasu+ 72))
...
#define usDBmHardwareVersion       (*((INT16U*)aDBMeasu+151))
#define usDBmSoftwareVersion       (*((INT16U*)aDBMeasu+152))
#define usDBmErrorStatus1          (*((INT16U*)aDBMeasu+153))
#define usDBmErrorStatus2          (*((INT16U*)aDBMeasu+154))
#define usDBmErrorStatus3          (*((INT16U*)aDBMeasu+155))
#define usDBmErrorStatus4          (*((INT16U*)aDBMeasu+156))
#define usDBmErrorStatus5          (*((INT16U*)aDBMeasu+157))
#define usDBmErrorStatus6          (*((INT16U*)aDBMeasu+158))
#define usDBmAdcFftChannel         (*((INT16U*)aDBMeasu+159))
#define usDBmFftResult              ((INT16U*)(aDBMeasu+160))
#define usDBmFftResult0            (*((INT16U*)aDBMeasu+160))
#define usDBmFftResult1            (*((INT16U*)aDBMeasu+161))
#define usDBmFftResult2            (*((INT16U*)aDBMeasu+162))
#define usDBmFftResult3            (*((INT16U*)aDBMeasu+163))
#define usDBmFftResult4            (*((INT16U*)aDBMeasu+164))
#define usDBmFftResult5            (*((INT16U*)aDBMeasu+165))
#define usDBmFftResult6            (*((INT16U*)aDBMeasu+166))
#define usDBmFftResult7            (*((INT16U*)aDBMeasu+167))
#define usDBmFftResult8            (*((INT16U*)aDBMeasu+168))
#define usDBmFftResult9            (*((INT16U*)aDBMeasu+169))
#define usDBmFftResult10           (*((INT16U*)aDBMeasu+170))
#define usDBmFftResult11           (*((INT16U*)aDBMeasu+171))
#define usDBmFftResult12           (*((INT16U*)aDBMeasu+172))
#define usDBmFftResult13           (*((INT16U*)aDBMeasu+173))
#define usDBmFftResult14           (*((INT16U*)aDBMeasu+174))
#define usDBmFftResult15           (*((INT16U*)aDBMeasu+175))
#define usDBmFftResult16           (*((INT16U*)aDBMeasu+176))
#define usDBmFftResult17           (*((INT16U*)aDBMeasu+177))
#define usDBmFftResult18           (*((INT16U*)aDBMeasu+178))
#define usDBmFftResult19           (*((INT16U*)aDBMeasu+179))
#define usDBmFftResult20           (*((INT16U*)aDBMeasu+180))
#define usDBmFftResult21           (*((INT16U*)aDBMeasu+181))
#define usDBmFftResult22           (*((INT16U*)aDBMeasu+182))
#define usDBmFftResult23           (*((INT16U*)aDBMeasu+183))
#define usDBmFftResult24           (*((INT16U*)aDBMeasu+184))
#define usDBmFftResult25           (*((INT16U*)aDBMeasu+185))
#define usDBmFftResult26           (*((INT16U*)aDBMeasu+186))
#define usDBmFftResult27           (*((INT16U*)aDBMeasu+187))
#define usDBmFftResult28           (*((INT16U*)aDBMeasu+188))
#define usDBmFftResult29           (*((INT16U*)aDBMeasu+189))
#define usDBmFftResult30           (*((INT16U*)aDBMeasu+190))
#define usDBmFftResult31           (*((INT16U*)aDBMeasu+191))
#define usDBmMeasuBackup1          (*((INT16U*)aDBMeasu+192))
#define usDBmMeasuBackup2          (*((INT16U*)aDBMeasu+193))
#define usDBmMeasuBackup3          (*((INT16U*)aDBMeasu+194))
#define usDBmMeasuBackup4          (*((INT16U*)aDBMeasu+195))
#define usDBmMeasuBackup5          (*((INT16U*)aDBMeasu+196))
#define usDBmMeasuBackup6          (*((INT16U*)aDBMeasu+197))
#define usDBmMeasuBackup7          (*((INT16U*)aDBMeasu+198))
#define usDBmMeasuBackup8          (*((INT16U*)aDBMeasu+199))
...
/*                           RUNING SIGN                                */
/* ******************************************************************** */
#define usDBhFLASHToSensor         (*((INT16U*)aDBMeasu+221))
