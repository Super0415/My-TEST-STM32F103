...
/* ******************************************************************** */
//温度
                       //Ω-VDO_163℃     0    32    64    96   128   192   256   480   600  1000
const INT16U aSFTempMap0Adc[10]   = {   17,  409,  732, 1006, 1236, 1606, 1891, 2522, 2731, 3150};
const INT16U aSFTempMap0Tmp[10]   = {  163,  110,   85,   73,   64,   53,   44,   35,   35,   35};
                       //Ω-SGH_140℃     0    19    32    56    77   106   217   327   508   600
const INT16U aSFTempMap1Adc[10]   = {   17,  225,  409,  660,  850, 1080, 1727, 2140, 2577, 2731};
const INT16U aSFTempMap1Tmp[10]   = {  140,  140,  120,  100,   90,   80,   60,   50,   40,   40};
                       //Ω-SGD_180℃     0     0    17    28    36    64   128   288   732   800
const INT16U aSFTempMap2Adc[10]   = {   17,   17,  237,  365,  454,  733, 1236, 2011, 2905, 2978};
const INT16U aSFTempMap2Tmp[10]   = {  180,  180,  130,  110,  100,   80,   60,   40,   20,   20};
                    //Ω-CURTIS_140℃     0     0    47    77   133   246   480   480   480   600
const INT16U aSFTempMap3Adc[10]   = {   17,   17,  568,  849, 1269, 1854, 2522, 2522, 2522, 2731};
const INT16U aSFTempMap3Tmp[10]   = {  140,  140,  120,  100,   80,   60,   35,   35,   35,   35};
                    //Ω-DATCON_140℃     0    25    55    76   106   197   426   952   952   952
const INT16U aSFTempMap4Adc[10]   = {   17,  331,  648,  841, 1080, 1631, 2406, 3115, 3114, 3114};
const INT16U aSFTempMap4Tmp[10]   = {  140,  140,  140,  120,  100,   80,   60,   40,   40,   40};
                  //Ω-VOLVO_EC_120℃     0    13    18    23    32    41    61   102   220   600
const INT16U aSFTempMap5Adc[10]   = {   17,  186,  247,  307,  409,  507,  705, 1050, 1739, 2731};
const INT16U aSFTempMap5Tmp[10]   = {  120,  120,  110,  100,   90,   80,   70,   60,   40,   40};
                       //Ω-SGX_140℃     0     0    21    28    39    56   116   258   300   500
const INT16U aSFTempMap6Adc[10]   = {   17,   17,  283,  365,  487,  658, 1151, 1899, 2052, 2559};
const INT16U aSFTempMap6Tmp[10]   = {  140,  140,  110,  100,   90,   80,   60,   40,   20,   20};
                     //Ω-PT100_180℃   100   112   127   135   139   147   155   158   162   170
const INT16U aSFTempMap7Adc[10]   = { 1023, 1122, 1226, 1278, 1304, 1354, 1402, 1420, 1442, 1492};
const INT16U aSFTempMap7Tmp[10]   = {    0,   30,   70,   90,  100,  120,  140,  150,  160,  180};
                     //Ω-欧3_120℃     115   146   188   245   333   435   596   834  2500  5896  
const INT16U aSFTempMap8Adc[10]   = { 1148, 1350, 1604, 1863, 2170, 2435, 2731, 3015, 3654, 3894};
const INT16U aSFTempMap8Tmp[10]   = {  120,  110,  100,   90,   80,   70,   60,   50,   20,   0};
...
//液位
                           //Ω-SGH       0    20    40    80   100   120   160   200   400   500 
const INT16U aSFLevelMap0Adc[10]  = {   17,  263,  494,  871, 1023, 1177, 1428, 1642, 2339, 2557};
const INT16U aSFLevelMap0Lvl[10]  = {    0,   10,   20,   40,   50,   60,   80,  100,  100,  100};
                          //Ω-SGD       0    20    40    80   100   120   160   200   400   500 
const INT16U aSFLevelMap1Adc[10]  = {   17,  263,  494,  871, 1023, 1177, 1428, 1642, 2339, 2557};
const INT16U aSFLevelMap1Lvl[10]  = {    0,   10,   20,   40,   50,   60,   80,  100,  100,  100};
                //Ω-YW-ES-8-2S(MS)       0    18    36    72    90   108   144   180   400   500 
const INT16U aSFLevelMap2Adc[10]  = {   17,  245,  452,  802,  953, 1090, 1336, 1539, 2340, 2557};
const INT16U aSFLevelMap2Lvl[10]  = {  100,   90,   80,   60,   50,   40,   20,    0,    0,   0 };
                           //Ω-ZHM      10    20    25    31    36    46    57    72    75   100 
const INT16U aSFLevelMap3Adc[10]  = {  146,  270,  332,  398,  453,  558,  666,  803,  829, 1023};
const INT16U aSFLevelMap3Lvl[10]  = {  100,   90,   60,   40,   20,    0,    0,    0,    0,    0};
...
//压力
                       //Ω-VDO_10bar     0    16    32    48    64    96   128   176   300   600
const INT16U aSFPressMap0Adc[10]  = {   17,  225,  410,  582,  729, 1003, 1233, 1518, 2050, 2729};//AD    //油压0
const INT16U aSFPressMap0Prs[10]  = {    0,    0,  179,  241,  338,  503,  703, 1034, 1034, 1034};
                      //Ω-SGH_10bar      0    25    35    59    98   134   192   200   240   600
const INT16U aSFPressMap1Adc[10]  = {   17,  330,  440,  685, 1019, 1272, 1603, 1643, 1827, 2729};
const INT16U aSFPressMap1Prs[10]  = {    0,    0,    0,  200,  400,  600, 1000, 1000, 1000, 1000};
                      //Ω-SGD_10bar      0    15    24    48    88   119   149   177   200   600
const INT16U aSFPressMap2Adc[10]  = {   17,  215,  319,  579,  938, 1172, 1368, 1525, 1643, 2729};//AD 
const INT16U aSFPressMap2Prs[10]  = {    0,    0,    0,  200,  400,  600,  800, 1000, 1000, 1000}; //Ω
                   //Ω-CURTIS_10bar      0    10    49    88   119   149   178   240   300   600
const INT16U aSFPressMap3Adc[10]  = {   17,  149,  590,  939, 1173, 1366, 1530, 1825, 2050, 2729};
const INT16U aSFPressMap3Prs[10]  = {    0,    0,  200,  400,  600,  800, 1000, 1000, 1034, 1034};
                   //Ω-Datcon_10bar      0    38    62   101   127   160   206   207   300   600
const INT16U aSFPressMap4Adc[10]  = {   17,  475,  711, 1023, 1227, 1429, 1671, 1676, 2049, 2729};
const INT16U aSFPressMap4Prs[10]  = { 1034, 1034,  758,  483,  345,  207,   69,    0,    0,    0};
                 //Ω-VOLVO_EC_10bar      0    12    58    93   124   152   184   250   251   600
const INT16U aSFPressMap5Adc[10]  = {   17,  172,  676,  983, 1209, 1386, 1565, 1866, 1870, 2730};
const INT16U aSFPressMap5Prs[10]  = {    0,    0,  200,  400,  600,  800, 1000, 1000,    0,    0};
                      //Ω-SGX_10bar      0    15    30    50    86   100   132   168   200   600
const INT16U aSFPressMap6Adc[10]  = {   17,  208,  383,  592,  919, 1079, 1305, 1518, 1671, 3730};  
const INT16U aSFPressMap6Prs[10]  = {    0,    0,  100,  200,  400,  500,  700, 1000, 1000, 1000};
...
/*                          SFGet1DMapCst10()                           */
/* ******************************************************************** */
INT16U SFGet1DMapCst10 (INT16U usX, const INT16U *pXX, const INT16U *pYY)   //注意：PXX必须从小到大
{   INT16U usD1, usD2, usD3, usD4;
    if (usX <= pXX[0])
    {   return pYY[0];
    }
...
//@@@@@@@@@@@@@@@ZC
#if(ENABLE_DB_H==1)
		  Temp = (INT32U)(((INT64U)pSpd->usCntMax * (INT64U)60000000) / (INT64U)DES_GEARTEETH);	
#else 
		  Temp = 	pSpd->uiSpdCst;			
#endif		
...
//					pSpd->usSpeed = (INT16U)(pSpd->uiSpdCst / uiPeriod);
						pSpd->usSpeed = (INT16U)(Temp / uiPeriod);
        }
    }
}
...
/*                          SFGetSensorPress()                          */
/* ******************************************************************** */
INT16U SFGetSensorPress (INT16U usAdc, INT16U usType)       //传感器数据 - 传感器类型
{   if (usType == 0)
...
//    {   uiSum              = 0;
//        usDBhErrorStatus1 |= usDBmErrorStatus1;
//        usDBhErrorStatus2 |= usDBmErrorStatus2;
//        usDBhErrorStatus3 |= usDBmErrorStatus3;
//        usDBhErrorStatus4 |= usDBmErrorStatus4;
//        usDBhErrorStatus5 |= usDBmErrorStatus5;
//        usDBhErrorStatus6 |= usDBmErrorStatus6;
...
{   INT16U usTmp;
    /* ************************* Power Supply ************************* */
    usDBmSupplyVoltage = pAin[SF_SUPPLY_VLT_CH] + SF_SUPPLY_VLT_CORR;        //电源电压
	  PowerVoltage = (usDBmSupplyVoltage*1796-15340)/10000;
    /* *********************** CPU Temperature ************************ */
    ...
    {   usTmp = pAin[usTmp];
        ...
        {   SF_ERR1_CLR_BIT(SF_ERR1_WATER_TMP_VT);				
				    if(DES_TEMP_SENSOR==0)
				    {
					      WATERTEMP=-32768;
				    }
				    else
				    {
					      usDBpCoolantTempSenType = DES_TEMP_SENSOR-1;    //@@@@@@@@@@@@@@@@@ZC链接数据库油压传感器类型
					      TESTZCSF[7] = DES_TEMP_SENSOR;
                usDBmCoolantTemperature = SFGetSensorTemp(usTmp, usDBpCoolantTempSenType);   //usDBpOilPressSenType 油压类型选择
					      TESTZCSF[8] = usDBmCoolantTemperature;
					      WATERTEMP = usDBmCoolantTemperature;            //@@@@@@@@@@@@@@@@@ZC
					  }					      
        }
    }   else
    {   SF_ERR1_CLR_BIT(SF_ERR1_WATER_TMP_VT);
    ...
    /* ************************* Oil Pressure ************************* */
    usTmp = usDBpAssignOilPress;      //序号-数据组中的位置
		TESTZCSF[0] = usTmp;
    if (usTmp < SF_NUM_OF_ANA_IN)     //预设24组AD值
    {   usTmp = pAin[usTmp];          //获取采集AD值
			  TESTZCSF[1] = usTmp;
        ...
        }   else
        {
				    ...
				    {
					      usDBpOilPressSenType = DES_OP_SENSOR-1;    //@@@@@@@@@@@@@@@@@ZC链接数据库油压传感器类型
					      TESTZCSF[2] = DES_OP_SENSOR;
                usDBmOilPressure = SFGetSensorPress(usTmp, usDBpOilPressSenType);   //usDBpOilPressSenType 油压类型选择
					      TESTZCSF[3] = usDBmOilPressure;
					      OILPRESSURE = usDBmOilPressure;            //@@@@@@@@@@@@@@@@@ZC
					  }
        }
    }   else
    {   SF_ERR1_CLR_BIT(SF_ERR1_OIL_PRES_VT);          //取消油压断线报警
    ...
    {   usTmp = pAin[usTmp];
        ...
        {   SF_ERR1_CLR_BIT(SF_ERR1_FUEL_LVL_VT);
				    ...
				    {
					      usDBpFuelLevelSenType = DES_LV_SENSOR-1;    //@@@@@@@@@@@@@@@@@ZC链接数据库油压传感器类型
					      TESTZCSF[12] = DES_LV_SENSOR;
                usDBmFuelLevel = SFGetSensorLevel(usTmp, usDBpFuelLevelSenType);   
					      TESTZCSF[13] = usDBmOilPressure;
					      FUEL = usDBmFuelLevel;            //@@@@@@@@@@@@@@@@@ZC
					  }
        }
    }   else
    {   SF_ERR1_CLR_BIT(SF_ERR1_FUEL_LVL_VT);
    ...
    {   usTmp = pAin[usTmp];
        ...
        {   SF_ERR1_CLR_BIT(SF_ERR1_CHARGER_VLT_VT);
            ...
            usDBpChargerVoltAdcHigh, usDBpChargerVoltRefLow, usDBpChargerVoltRefHigh);
					  ChargerVoltage = usDBmChargerVoltage;    //充电机电压
        }
    }   else
    {   SF_ERR1_CLR_BIT(SF_ERR1_CHARGER_VLT_VT);
        usDBmChargerVoltage = usDBpSubstChargerVolt;
