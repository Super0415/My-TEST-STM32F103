...
#define XIO_GPO_PT_A_L           PB13          /* Pin15, PC0, TIM1-CH1  */
#define XIO_GPO_PT_B_L           PB14          /* Pin15, PC0, TIM1-CH1  */
#define XIO_GPO_PT_C_L           PB15          /* Pin15, PC0, TIM1-CH1  */
...
XIO_EXT void   XIO_SetState(GPIO_TypeDef *pPt,INT08U ucBit,u8 usSet);
