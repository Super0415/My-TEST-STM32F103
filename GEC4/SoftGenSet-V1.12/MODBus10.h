...
/*  MOD_VERSION  = 760x: GEC7600-Main Application                       */
/*  MOD_VERSION  = 761x: GEC7600-Display Application                    */
/*  MOD_VERSION  = 780x: GEC7800-Main Application                       */
/*  MOD_VERSION  = 781x: GEC7800-Display Application                    */
/*  MOD_VERSION  = 80xx: VEC8000 Application                            */
/*  MOD_VERSION  = 90xx: VEC9000 Application                            */
/*  MOD_VERSION  = 96xx: VEC9600 Application                            */
/* ******************************************************************** */

#define MOD_VERSION           7800
...
#define MOD_7600_MAIN_CHIP_ON    0
#define MOD_7600_AUX_CHIP_ON     0
#define MOD_7800_COMMON_ON       0
#define MOD_7800_MAIN_CHIP_ON    0
#define MOD_7800_AUX_CHIP_ON     0
...
#endif
#if   ((MOD_VERSION / 10)   == 760)
#undef  MOD_7600_MAIN_CHIP_ON
#define MOD_7600_MAIN_CHIP_ON    1
#endif
#if   ((MOD_VERSION / 10)   == 761)
#undef  MOD_7600_AUX_CHIP_ON
#define MOD_7600_AUX_CHIP_ON     1
#endif
#if   ((MOD_VERSION / 100)   == 78)
#undef  MOD_7800_COMMON_ON
#define MOD_7800_COMMON_ON       1
#endif
#if   ((MOD_VERSION / 10)   == 780)
#undef  MOD_7800_MAIN_CHIP_ON
#define MOD_7800_MAIN_CHIP_ON    1
#endif
#if   ((MOD_VERSION / 10)   == 781)
#undef  MOD_7800_AUX_CHIP_ON
#define MOD_7800_AUX_CHIP_ON     1
#endif
...
#define MOD_CPU_STM32F103_ON     0
#define MOD_CPU_STM32F105_ON     0
...
#endif
#if    (MOD_7600_MAIN_CHIP_ON == 1)
#undef  MOD_CPU_STM32F105_ON
#define MOD_CPU_STM32F105_ON     1
#undef  MOD_MODBUS_V10_ON
#define MOD_MODBUS_V10_ON        1
#endif
#if    (MOD_7600_AUX_CHIP_ON  == 1)
#undef  MOD_CPU_STM32F103_ON
#define MOD_CPU_STM32F103_ON     1
#endif
#if    (MOD_7800_COMMON_ON    == 1)
#undef  MOD_CPU_STM32F1_ON
#define MOD_CPU_STM32F1_ON       1
#endif
#if    (MOD_7800_MAIN_CHIP_ON == 1)
#undef  MOD_CPU_STM32F105_ON
#define MOD_CPU_STM32F105_ON     1
#undef  MOD_MODBUS_V10_ON
#define MOD_MODBUS_V10_ON        1
#endif
#if    (MOD_7800_AUX_CHIP_ON  == 1)
#undef  MOD_CPU_STM32F103_ON
#define MOD_CPU_STM32F103_ON     1
#endif
...
#define MOD_OVER_TIMER          TIM2->CCR1
...
#define MOD_US_CREAT(l,h)      ((INT16U)(l)+((INT16U)(h)<<8))
...
MOD_EXT void   MODInitTim2Ch1Timer(void);
