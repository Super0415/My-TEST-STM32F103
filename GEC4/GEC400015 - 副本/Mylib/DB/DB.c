...
{   usDBpGensCtRatio           = 1;
    ...
    usDBpAssignBoostPress      = 65535;
		...
		usDBpAssignChargerVolt     = 15;     //充电机电压
    ...
    usDBpFuelLevelErrHigh = 4000;
		//充电机电压设置
		usDBpChargerVoltErrLow = 10;
    usDBpChargerVoltErrHigh = 4000;
		usDBpChargerVoltAdcLow = 567;
		usDBpChargerVoltAdcHigh = 1537;
		usDBpChargerVoltRefLow = 107;
		usDBpChargerVoltRefHigh = 275;
}
