...
//	if((usFW100msTimer%10 == 0)&&CANSEND==0)
//	{
//		CANTxMessage.ExtId=0x1314;				 //使用的扩展ID
//		CANTxMessage.IDE=CAN_ID_EXT;			 //扩展模式
//		CANTxMessage.RTR=CAN_RTR_DATA;		 //发送的是数据
//		CANTxMessage.DLC=4;							 //数据长度为3字节
//		CANTxMessage.Data[0]=0xAA;
//		CANTxMessage.Data[1]=0xBB;
//		CANTxMessage.Data[2]=0xCC;
//		CANTxMessage.Data[3]=0xDD;
//		CAN_Transmit(CAN1, &CANTxMessage);//发送消息
//		CANSEND=1;
//	}
//	if(usFW100msTimer%10==1)
//	{
//	  CANSEND=0;
//	}
