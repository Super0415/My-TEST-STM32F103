...
#define  sHidPAGE_ADDR    (0x08000000 + 508 * 1024)//读出隐藏参数
...
/* ******************************************************************** */
/*             void FLASH_SavesHidParm()                        */
//                                  
/* ******************************************************************** */
void FLASH_SavesHidParm(void)
{
	MemWriteByte((uint16*)(FLASHDATABASE+sPn_MID_PASSWORD),sHidParmPageCon1*2,sHidPAGE_ADDR  );//保存校验参数
}
