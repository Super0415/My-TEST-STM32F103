...
{  
 ...
 {                                                                                                                  
  "温度高报警停机(IN)       ", "低油压报警停机 (IN)      ", "低燃油位报警停机 (IN)    ","低冷却液位报警停机(IN)   ",  "停机失败警告             ",        
	"输入口报警停机           ", "温度传感器断线停机       ", "压力传感器断线停机       ","液位传感器断线停机       ",                       "bit9",                  
 ...
 {							                                                                                         
  "速度信号丢失警告         ", "发电过流警告             ", "液位传感器断线警告       ", "然油位低警告             ",  "充电失败警告             ",      
...
const SpPage SpPage5=
 {
   ...
   &SpPage_Sel_Pub[33].Line_EN[0],&SpPage_Sel_Pub[93].Line_EN[0],&SpPage_Sel_Pub[94].Line_EN[0],
   ...
   &SpPage_Sel_Pub[33].Line_CN[0],&SpPage_Sel_Pub[93].Line_CN[0],&SpPage_Sel_Pub[94].Line_CN[0],
 };
...
const SpManyPage SpManyShow=
 ...
 const typPGLib   Page_Status_P0_1_CN[] =
 {                              	                              					   	
	{"市电"                      ,   "L-N                        V", "L-L                        V", 
	 "F             Hz            ", "", "", 
	},  														 
 ...
 const typPGLib   Page_Status_P0_1_EN[] =
 {
  {"Mains                       ", "L-N                        V", "L-L                        V", 
	 "Freq          Hz            ", "", "", 
	},						  
...
const Page PageP0_1=
 {
   6,     //表示本显示页面有 X 个显示行
   &Page_Status_P0_1_EN[0].line1[0],&Page_Status_P0_1_EN[0].line2[0],
   &Page_Status_P0_1_EN[0].line3[0],&Page_Status_P0_1_EN[0].line4[0],
   &Page_Status_P0_1_EN[0].line5[0],&Page_Status_P0_1_EN[0].line6[0],
   
   &Page_Status_P0_1_CN[0].line1[0],&Page_Status_P0_1_CN[0].line2[0],
   &Page_Status_P0_1_CN[0].line3[0],&Page_Status_P0_1_CN[0].line4[0],
   &Page_Status_P0_1_CN[0].line5[0],&Page_Status_P0_1_CN[0].line6[0],
 }; 
const Page PageP1=
 {
   6,     //表示本显示页面有 X 个显示行
...
//1：发电    2：磁传感器+发电    4：发电+油压  5：磁传感器+发电+油压
 ...
 {
  8,         //表示有 X 个显示页面
  &PageP0,&PageP0_1,&PageP1,&PageP2,&PageP3,&PageP4,&PageP5,&PageAlarmList,
 };
//0：磁感器 3：磁传感器+油压
 ...
 { 
  ...
  const typPGLib   Page_SysMege_P1_CN[] =
   {
      {"     控制器信息",      "软件版本:GEC4800-100 V1.00","硬件版本:GEC4800-1.1","发布日期:2017-11-27"," "}, 
   };
  const typPGLib   Page_SysMege_P1_EN[] =
   {
      {"    Information",     "Soft Ver:GEC4800-100 V1.00", "Hard Ver:GEC4800-1.1", "Issue: 2017-11-27"," "},
   };  
...
{                                                                                                                                                           
 ...
 /*-47-*/ {(lPubMenuLabel)sPn_COMMON_INPUTFUNC1      , 0x44,  {"45 可编程输入口1设置"},  {"45 Digit input 1 set"},   {"04"},{&Characters_Library_CN[44][0]},{&Characters_Library_EN[44][0]},{ 0},{  17},{   1}, {0},},
 ...
 /*-50-*/ {(lPubMenuLabel)sPn_COMMON_INPUTFUNC2      , 0x44,  {"48 可编程输入口2设置"},  {"48 Digit input 2 set"},   {"06"},{&Characters_Library_CN[47][0]},{&Characters_Library_EN[47][0]},{ 0},{  17},{  10}, {0},},
 ...
 /*-53-*/ {(lPubMenuLabel)sPn_COMMON_INPUTFUNC3      , 0x44,  {"51 可编程输入口3设置"},  {"51 Digit input 3 set"},   {"08"},{&Characters_Library_CN[50][0]},{&Characters_Library_EN[50][0]},{ 0},{  17},{   2}, {0},},
...
//***************ADD
 const SpPGLib   SpHidPageSelib[] =
 {
   /*-00-*/ {{"00 无效              "}, {"00 Used               "}},
   /*-01-*/ {{"01 累计时间          "}, {"01 NO Used            "}},
   /*-01-*/ {{"02 额定时间          "}, {"01 NO Used            "}},
 };                                                                  
                                                                    
const SpPage SpHidPage1=
 {
   3,     
   &SpHidPageSelib[ 0].Line_EN[0],&SpHidPageSelib[ 1].Line_EN[0],&SpHidPageSelib[ 2].Line_EN[0],
   
   &SpHidPageSelib[ 0].Line_CN[0],&SpHidPageSelib[ 1].Line_CN[0],&SpHidPageSelib[ 2].Line_CN[0],
 };

const SpManyPage SpHidSubPgShow=
 {
  1,         
  &SpHidPage1,
 };
const ParamStruct HIDPARAMS_PASS[]=                                                                                                             
{                                                                                                                                                           
 /*-01-*/ {(lPubMenuLabel)sPn_MID_PASSWORD        , 0x00,  {"01 界面口令"},       {"01 Mains normal delay"},  {"  "},{&Characters_Library_CN[61][0]},{&Characters_Library_EN[61][0]},{ 0},{9999},{4321}, {0},},
 /*-02-*/ {(lPubMenuLabel)sRa_MidSysNowYear       , 0xC0,  {"02 当前时间设置"},   {"02 Mains abnorm delay"},  {"  "},{&Characters_Library_CN[78][0]},{&Characters_Library_EN[78][0]},{ 0},{9999},{9999}, {0},},
 /*-03-*/ {(lPubMenuLabel)sRa_MainTenanceYear     , 0xE0,  {"03 维保时间设置"},   {"03 Mains under volt"},    {"  "},{&Characters_Library_CN[78][0]},{&Characters_Library_EN[78][0]},{ 0},{9999},{9999}, {4},},
 /*-04-*/ {(lPubMenuLabel)sRa_MainTenanceVALID    , 0x08,  {"04 维保有效"},       {"03 Mains under volt"},    {"00"},{&Characters_Library_CN[79][0]},{&Characters_Library_EN[79][0]},{ 0},{2}   ,{   0}, {8},},	 
};

const SubMenu HIDMENU_PARM=                                                                             
{                                                                                                                                                                                                                       
  "",
  "",   
  lPubLabel2,
  sHidParmPageCon,                 //GEC400控隐藏参数页面数量
  {
    &HIDPARAMS_PASS[0], 
		&HIDPARAMS_PASS[1], 
		&HIDPARAMS_PASS[2], 
