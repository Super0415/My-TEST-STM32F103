...
//    usXIOAdcChRef8  =  usDBpAdcChRef8;
    ...
    SFSoftFreqInit(&sXIOSoftFreq0, 16);  //usDBpAdcChFilter0
    SFSoftFreqInit(&sXIOSoftFreq1, 16);
    SFSoftFreqInit(&sXIOSoftFreq2, 16);
    SFSoftFreqInit(&sXIOSoftFreq3, 16);
    SFSoftFreqInit(&sXIOSoftFreq4, 16);
    SFSoftFreqInit(&sXIOSoftFreq5, 16);
    SFSoftFreqInit(&sXIOSoftFreq6, 16);
    SFSoftFreqInit(&sXIOSoftFreq7, 16);
    SFSoftFreqInit(&sXIOSoftFreq8, 16);  //usDBpAdcChFilter8
