...
/* ******************************************************************** */
//#define LCD_LCD_FUNCTION_ON      0
//@@@@@@@@@@@@@@
#define LCD_LCD_FUNCTION_ON      1
//@@@@@@@@@@@@@@
...
/*                          Variable Definition                         */
/* ******************************************************************** */
LCD_EXT INT16U usLCDTimer;
LCD_EXT INT16U usLCDStatus;
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ZC
LCD_EXT void Delay_100ms(int Period);
#define K_STOP    usDBmKeyEngineStop
#define K_MAN     usDBmKeyModeManual
#define K_AUTO    usDBmKeyModeAuto

#define K_START   usDBmKeyErrorReset   //@@@@@@@ZC  注意此处定义错位
#define K_SET     usDBmKeyEngineStart

#define K_UP      usDBmKeyMenuUp
#define K_DOWN    usDBmKeyMenuDown
#define K_ENTER   usDBmKeyMenuEnter
